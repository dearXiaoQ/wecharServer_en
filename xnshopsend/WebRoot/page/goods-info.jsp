...
<body id="wrap">
	...
	<div class="sjsc-title1" style="position:fixed;z-index：999">
		<h3 class="sjsc-t1l f-l">
			<a href="JavaScript:window.location.href=document.referrer"><span
				class="le"><img src="images/back.png" alt=""
	...
	<c:forEach items="${list}" var="list">
		...
		<div class="spxq-info2">
			<ul class="spxq-ul2">
				<li class="current" style="width: 100%"><a href="JavaScript:;">Graphic details</a></li>
	...
	<div class="spxq-info3">
		<button class="if3-btnn if3-btn1 f-l"
			onclick="buy()">Order Now</button>
		<button class="if3-btnn if3-btn2 f-l" onclick="add()">Add to Cart</button>
		<a href="cartList.html" class="if3-aa f-l"><img
			src="images/cart.png"><span
			style="position:fixed;color: #ff3c00" id="cart_num">${cart_num }</span></a>
					...
					.ajax({
						...
						success : function(rs) {
							...
							if (data.rs_code == 1) {
								...
								//	showTip("已加入购物车！");
								//					location.reload();
								window.location.href = 'goodsOrder.html?goods_id=' + goods_id;
							} else if (data.rs_code == 2) {
								showTip("Out of Stock！");
							} else {
								showTip("Failed to join the cart！");
							}
